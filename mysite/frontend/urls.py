...
from shopapp.views import RegisterView, MyLoginView
...
urlpatterns = [
    ...
    path('sign-in/', MyLoginView.as_view(template_name="frontend/signIn.html")),
    path('sign-up/', RegisterView.as_view(template_name="frontend/signUp.html")),
    path('logout/', LogoutView.as_view(template_name="frontend/index.html")),
    path('frontend/static/', TemplateView.as_view(template_name="frontend/index.html")),
]
